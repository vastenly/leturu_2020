package com.vastenly.taf.utils.string;

import static com.vastenly.taf.utils.StringUtils.isBlank;
import static com.vastenly.taf.utils.NumberUtils.isNull;
import static com.vastenly.taf.utils.string.StringValidator.getInetAddressType;
import static com.vastenly.taf.utils.string.StringValidator.isDomainName;
import static com.vastenly.taf.utils.string.StringValidator.isIPv4Address;
import static com.vastenly.taf.utils.string.StringValidator.isIPv6Address;
import static com.vastenly.taf.utils.string.StringValidator.isTcpUdpPort;

import com.vastenly.taf.core.enums.InetAddressType;
import com.vastenly.taf.core.enums.Protocol;
import com.vastenly.taf.utils.exceptions.InvalidDomainNameException;
import com.vastenly.taf.utils.exceptions.InvalidIPv4AddressException;
import com.vastenly.taf.utils.exceptions.InvalidIPv6AddressException;
import com.vastenly.taf.utils.exceptions.IpOctetOutOfBoundException;
import com.vastenly.taf.utils.exceptions.TcpUdpPortOutOfBoundException;
